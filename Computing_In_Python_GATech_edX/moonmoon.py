...
super_moon = (phase == "Full") and (distance < 230000)
blue_moon = (phase == "Full") and (date >= 29)
blood_moon = (phase == "Full") and eclipse
full = (phase == "Full") and (distance > 230000) and (date <= 28) and not eclipse

if super_moon and blue_moon and blood_moon:
    print("Super Blue Blood Moon")
elif super_moon and blue_moon:
    print("Super Blue Moon")
elif super_moon and blood_moon:
    print("Super Blood Moon")
elif blue_moon and blood_moon:
